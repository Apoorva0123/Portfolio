  ...
  return (
    <div name="home" className='w-full h-screen bg-[#0a192f]'>
        ...
        <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
            ...
            <h1 className='text-4xl sm:text-7xl font-bold text-[#ccd6f6]'>Apoorva Kaniti</h1>
            ...
            <div>
                <button className='text-white border-2 px-6 py-3 my-2 flex items-center hover:bg-pink-600 hover:border-pink-600'>View Work <HiArrowNarrowRight className='ml-4'/></button>
            </div>
        </div>
    </div>
  )
